...
- `docs/`, twelve longer-form documentation files for users who want to read before doing; `08-updating.md` and `09-safety.md` are the two most owners come back to.
...
**8. Read the Welcome and method pages.** Have them read `Welcome.md`, then `wiki/How to Use This Wiki.md`, then come back to you. Encourage them to skim, not study; the system is meant to be used, not memorised.
