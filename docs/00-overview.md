...
Or, simplest of all: follow [`../START_HERE.md`](../START_HERE.md). You run the installer yourself, then open Claude in your new wiki and say "get me started"; Claude asks how you work and suggests only the extras that fit.
