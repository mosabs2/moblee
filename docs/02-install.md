...
**With Claude:** this step applies as written. **With ChatGPT:** Moblee does not set this up for ChatGPT yet. You can still hold the first conversation: open ChatGPT and, from its File menu, choose Open Folder and pick your wiki folder, then say **get me started**. <!-- verify on testdev -->
...
- With ChatGPT: open ChatGPT and, from its File menu, choose Open Folder and pick your wiki folder; ChatGPT can see your vault. <!-- verify on testdev -->
