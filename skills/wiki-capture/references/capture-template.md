...
<The substantive material. For a chat exchange, a compiled synthesis in analytical prose. For a save-back of an answer or a brain-skill output, the produced text in full: do not summarise or truncate, because this note is the source of record for the later ingest. House style applies: British English, analytical prose not bullet lists, no em dashes, absolute dates, citations with [[Page Name]] and section anchors.>

## Suggested integration

<Per target page, what should change and where. This is the block the ingest pass reads to route the material.>

- On **[[Page Name]]**: <what to add or change, and in which section>
- On **[[Other Page]]**: <what to add or change>
